...
\caption{Overlap ratio by entropy tercile for each dataset. High-entropy nodes consistently receive substantially more overlap assignments than low-entropy nodes, validating that membership ambiguity is a principled criterion for selecting overlap candidates.}
