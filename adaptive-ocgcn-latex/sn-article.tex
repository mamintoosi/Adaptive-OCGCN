...
IMDB      & 0.393~$\pm$~0.012 & 0.428~$\pm$~0.015 & 0.435~$\pm$~0.010 & \textbf{0.443~$\pm$~0.012} & 0.438~$\pm$~0.011 \
	extbf{Average}   & 	extbf{0.693} & 	extbf{0.722} & 	extbf{0.716} & 	extbf{0.731} & 	extbf{0.728} \\
\bottomrule
\end{tabular}
\end{table}
...
\subsubsection{Dataset Ambiguity Statistics}
...
\subsubsection{Correlation Between Ambiguity and Overlap}
...
\subsubsection{Stratified Ambiguity Analysis}
...
\subsubsection{Why Adaptive WMC Helps Some Datasets More Than Others}
