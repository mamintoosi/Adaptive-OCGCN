...
\begin{enumerate}
  ...
  \item \textbf{OCGCN with fixed WMC:} The original OCGCN~\citep{Amintoosi2021} with fixed WMC thresholds of 0.10, 0.20, 0.30, 0.40, and 0.50, representing the upper bound when hyperparameters are tuned.
